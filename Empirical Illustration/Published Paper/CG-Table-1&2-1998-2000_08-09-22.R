########################################################
## Application Routine                                ##
## For: Results of Table 1 and 2, 1998-2000 Subsample ##
...
BW <- read.csv(file = "BWs-1998-2000.csv",header =TRUE)
bwPf <- BW$bwPf
bwPm <- BW$bwPm
...
save.image("SelectedDataTmp98-00_NP.RData",compress="xz")
...
# compute test:
CQ_stat_2f_1 <- LocVBDNTest(Yfs,qfhat, kweightsf, size=c(.1,.05), tau_grid, B=1000)
...
kweightsf <-  Kweights((Pfs-delta)/hp)
# compute test:
CQ_stat_2f_2 <- LocVBDNTest(Yfs,qfhat, kweightsf, size=c(.1,.05), tau_grid, B=1000)
...
kweightsf <-  Kweights((Pfs-delta)/hp)
# compute test:
CQ_stat_2f_3 <- LocVBDNTest(Yfs,qfhat, kweightsf, size=c(.1,.05), tau_grid, B=1000)
...
kweightsf <-  Kweights((Pfs-delta)/hp)
# compute test:
CQ_stat_2f_4 <- LocVBDNTest(Yfs,qfhat, kweightsf, size=c(.1,.05), tau_grid, B=1000)



## SAVE WORK SPACE
save.image("SelectedDataFINAL98-00_NP.RData",compress="xz")
